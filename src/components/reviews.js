...
function Reviews(){
    ...
    const reviews = [
        {
            fullname: "محمد عزیزی", 
            img: process.env.PUBLIC_URL + "/images/profile-picture1.png",
        ...
        },
        {
            ...
            img: process.env.PUBLIC_URL + "/images/profile-picture2.png",
        ...
        }, 
        {
            ...
            img: process.env.PUBLIC_URL + "/images/profile-picture3.png",
